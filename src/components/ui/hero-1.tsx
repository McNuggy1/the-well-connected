...
const HERO_LOGOS = [
  { src: "https://upload.wikimedia.org/wikipedia/commons/2/22/Nvidia_logo.svg", alt: "Partner" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/b/b5/Eventbrite_Logo.svg", alt: "Partner" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/4/44/Bloomberg_Logo.svg", alt: "Partner" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg", alt: "Partner" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg", alt: "Partner" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg", alt: "Partner" },
];
...
export function HeroSection() {
  return (
    <section className="mx-auto w-full max-w-5xl">
      ...
      >
        <div className="absolute inset-0 -top-14 isolate -z-10 bg-[radial-gradient(35%_80%_at_49%_0%,#ADA8D320,transparent)] contain-strict" />
      </div>
      ...
      <div className="relative flex flex-col items-center justify-center gap-5 pt-32 pb-24">
        ...
        >
          ...
          <span className="text-xs">Events & sponsorships that scale</span>
        ...
        <h1
          className={cn(
            ...
            "text-shadow-[0_0px_50px_rgba(0,0,0,0.1)]"
          )}
        >
          Crafting Unforgettable <br /> Experiences & Connections
        </h1>
        ...
        <p className="fade-in slide-in-from-bottom-10 mx-auto max-w-md animate-in fill-mode-backwards text-center text-base text-foreground/80 tracking-wider delay-200 duration-500 ease-out sm:text-lg md:text-xl">
          Event and sponsorship strategies that connect brands and audiences
          authentically.
        </p>

        <div className="fade-in slide-in-from-bottom-10 flex animate-in flex-row flex-wrap items-center justify-center gap-3 fill-mode-backwards pt-2 delay-300 duration-500 ease-out">
          <Button className="rounded-full bg-wistful text-white hover:bg-wistful/90" size="lg" variant="secondary" asChild>
            <a href="#contact">
              <PhoneCallIcon className="size-4 mr-2" data-icon="inline-start" />
              Book a Call
            </a>
          </Button>
          <Button className="rounded-full bg-las-palmas text-black hover:bg-las-palmas/90" size="lg" asChild>
            <a href="#services">
              Get started
  ...
  return (
    <section className="relative space-y-4 border-t pt-6 pb-10">
      <h2 className="text-center font-medium text-lg text-muted-foreground tracking-tight md:text-xl">
        Trusted by <span className="text-foreground">leading brands</span>
      </h2>
      <div className="relative z-10 mx-auto max-w-4xl">
        <LogoCloud logos={HERO_LOGOS} />
      </div>
    </section>
  );
}
